namespace maridoces.Cards
{
    partial class carddois
    {
        ...
        private void InitializeComponent()
        {
            ...
            pct_lowcarb = new PictureBox();
            ((System.ComponentModel.ISupportInitialize)pct_imagem).BeginInit();
            pnl_central.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)pct_lowcarb).BeginInit();
            SuspendLayout();
            // 
            // pct_imagem
            // 
            ...
            // pnl_central
            // 
            pnl_central.Controls.Add(pct_lowcarb);
            ...
            // pct_lowcarb
            // 
            pct_lowcarb.BackColor = Color.Transparent;
            pct_lowcarb.Location = new Point(86, 3);
            pct_lowcarb.Name = "pct_lowcarb";
            pct_lowcarb.Size = new Size(55, 51);
            pct_lowcarb.TabIndex = 3;
            pct_lowcarb.TabStop = false;
            pct_lowcarb.Click += pct_lowcarb_Click;
            // 
            // carddois
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)pct_lowcarb).EndInit();
            ResumeLayout(false);
        }
        ...
        private PictureBox pct_lowcarb;
    }
}
